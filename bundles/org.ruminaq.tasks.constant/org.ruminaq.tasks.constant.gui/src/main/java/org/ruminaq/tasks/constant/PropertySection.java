...
import org.ruminaq.model.model.dt.Control;
...
public class PropertySection implements IPropertySection, ValueSaveListener {
    ...
    private void initLayout(Composite parent) {
        ...
        GridData valueLayoutData = new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1);
    ...
    private void initComponents(TransactionalEditingDomain ed) {
        ...
        valueComposites.put(Bool.class.getSimpleName(), new BoolPropertyValue(this, valueRoot, pe, ed));
        valueComposites.put(Complex32.class.getSimpleName(), new ComplexPropertyValue(this, valueRoot, pe, ed));
        valueComposites.put(Complex64.class.getSimpleName(), new ComplexPropertyValue(this, valueRoot, pe, ed));
        valueComposites.put(Control.class.getSimpleName(), new ControlPropertyValue(this, valueRoot, pe, ed));
        valueComposites.put(Int32.class.getSimpleName(), new NumericPropertyValue(this, valueRoot, pe, ed));
        valueComposites.put(Int64.class.getSimpleName(), new NumericPropertyValue(this, valueRoot, pe, ed));
        valueComposites.put(Float32.class.getSimpleName(), new NumericPropertyValue(this, valueRoot, pe, ed));
        valueComposites.put(Float64.class.getSimpleName(), new NumericPropertyValue(this, valueRoot, pe, ed));
        valueComposites.put(Decimal.class.getSimpleName(), new NumericPropertyValue(this, valueRoot, pe, ed));
        valueComposites.put(Text.class.getSimpleName(), new TextPropertyValue(this, valueRoot, pe, ed));

        valueComposites.putAll(extensions.getValueComposites(this, valueRoot, pe, ed));
    }
                ...
                if (dt != null) {
                    ModelUtil.runModelChange(() -> {
                        ...
                        if (bo instanceof Constant) {
                            ...
                            constant.getOutputPort().get(0).getDataType().add(EcoreUtil.copy(dt));

                            PropertyValueComposite vc = valueComposites.get(ModelUtil.getName(dt.getClass(), false));
                            if(vc == null) {
    ...
    public void refresh(PictogramElement pe, TransactionalEditingDomain ed) {
        if (pe != null) {
            ...
            for (String dt : cmbType.getItems()) {
                if (dt.equals(ModelUtil.getName(constant.getDataType().getClass(), false))) {
                    break;
                }
                i++;
            }
            ...
            PropertyValueComposite vc = valueComposites.get(
