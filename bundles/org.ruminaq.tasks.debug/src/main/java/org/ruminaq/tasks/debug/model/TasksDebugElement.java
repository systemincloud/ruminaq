...
public abstract class TasksDebugElement extends DebugElement implements ISuspendResume,
                                                                        IDisconnect,
                                                                        ITerminate,
                                                                        IStep,
                                                                        IStateElement {
	...
	@Override public String getModelIdentifier() { return TasksDebugModelPresentation.ID; }

	protected TasksDebugElement(IDebugTarget target) {
		super(target);
	}

	@Override public TasksDebugTarget getDebugTarget() { return (TasksDebugTarget) super.getDebugTarget(); }
	...
	@Override public boolean isTerminated()   { return ((TasksDebugElement) getDebugTarget()).getState() == MainState.TERMINATED; }
