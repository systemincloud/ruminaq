...
public class TasksDebugTarget extends TasksDebugElement implements IDebugTarget, ISicTarget {

    private final Logger logger = ModelerLoggerFactory.getLogger(TasksDebugTarget.class);

    protected EventDispatchJob  dispatcher;
    protected ILaunch           launch;
    protected IProject          project;
    protected TasksProcess      process;
    protected List<Task> tasks = Collections.synchronizedList(new LinkedList<Task>());

    @Override public TasksDebugTarget getDebugTarget() { return this; }

    @Override public void setState(IState state) { super.setState(state); }

    public TasksDebugTarget(ILaunch launch, IProject project, EventDispatchJob dispatcher) {
        super(null);
        this.launch     = launch;
    ...
    @Override public boolean   hasThreads() throws DebugException { return !tasks.isEmpty(); }
    @Override public IThread[] getThreads() throws DebugException {
