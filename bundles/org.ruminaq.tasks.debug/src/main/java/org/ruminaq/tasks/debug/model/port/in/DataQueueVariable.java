...
public class DataQueueVariable extends SicVariable {
	...
	@Override public String getValueString() { return se.getState() != MainState.SUSPENDED ? "see only when suspended" : ""; }
	...
	@Override public boolean     hasVariables() { return se.getState() != MainState.SUSPENDED ? false : dataQueue.size() > 0; }
	@Override public IVariable[] getVariables() { return dataQueue.toArray(new IVariable[dataQueue.size()]); }
