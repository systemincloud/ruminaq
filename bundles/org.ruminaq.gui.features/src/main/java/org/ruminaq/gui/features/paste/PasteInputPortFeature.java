...
public class PasteInputPortFeature extends SicPasteFeature implements PasteAnchorTracker {
	...
	public PasteInputPortFeature(IFeatureProvider fp, PictogramElement oldPe, int xMin, int yMin) {
		super(fp);
		this.oldPe = oldPe;
		this.xMin  = xMin;
		this.yMin  = yMin;
	...
	public void paste(IPasteContext context) {
		...
		InputPort      oldBo    = null;
	  	...
	  	for(Object o : getAllBusinessObjectsForPictogramElement(oldPe)) {
	  		if(o instanceof InputPort)          oldBo = (InputPort) o;
