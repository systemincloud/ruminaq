...
public class JavaTasksDebugTarget extends JavaTasksDebugElement implements IDebugTarget, ISicTarget {

    private final Logger logger = ModelerLoggerFactory.getLogger(JavaTasksDebugTarget.class);

    protected EventDispatchJob  dispatcher;
    protected ILaunch           launch;
    protected IProject          project;
    protected JavaTasksProcess  process;
    protected List<JavaTask> tasks = Collections.synchronizedList(new LinkedList<JavaTask>());

    @Override public JavaTasksDebugTarget getDebugTarget() { return this; }

    @Override public void setState(IState state) { super.setState(state); }

    public JavaTasksDebugTarget(ILaunch launch, IProject project, EventDispatchJob dispatcher) {
        super(null);
        this.launch     = launch;
    ...
    @Override public String  getName()   { return "Java Tasks"; }
