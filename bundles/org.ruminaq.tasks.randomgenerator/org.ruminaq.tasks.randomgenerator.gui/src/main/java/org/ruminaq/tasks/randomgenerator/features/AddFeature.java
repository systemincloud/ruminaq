...
public class AddFeature extends AddTaskFeature {
	...
	@Override protected int                         getHeight()           { return 55; }
	@Override protected int                         getWidth()            { return 55; }
	@Override protected boolean                     useIconInsideShape()  { return true; }
	@Override protected String                      getInsideIconId()     { return Images.K.IMG_RANDOMGENERATOR_DIAGRAM.name(); }
	@Override protected String                      getInsideIconDesc()   { return "???"; }
