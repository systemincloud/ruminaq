...
public interface GuiExtension {
	...
	default Map<String, IPaletteCompartmentEntry> getPaletteCompartmentEntries(ICreateFeature[] cfs) {
		return Collections.emptyMap();
	}

	default Map<String, IPaletteCompartmentEntry> getTestPaletteCompartmentEntries(ICreateFeature[] cfs) {
		return Collections.emptyMap();
	}

	default Collection<ICreateFeature> getCreateFeatures(IFeatureProvider fp) {
		return Collections.emptyList();
	}

	default Collection<ICreateConnectionFeature> getCreateConnectionFeatures(IFeatureProvider fp) {
		return Collections.emptyList();
	}

	default Collection<ICustomFeature> getCustomFeatures(IFeatureProvider fp){
		return Collections.emptyList();
	}

	default Collection<IContextButtonPadTool> getContextButtonPadTools(Object bo) {
		return Collections.emptyList();
	}

	default Collection<IDecorator> getDecorators(PictogramElement pe, IFeatureProvider fp) {
		return Collections.emptyList();
	}

	default Collection<IContextMenuEntry> getContextMenu(ICustomContext cxt, IFeatureProvider fp) {
		return Collections.emptyList();
	}
