...
public class PasteOutputPortFeature extends RuminaqPasteFeature implements PasteAnchorTracker {
	...
	public PasteOutputPortFeature(IFeatureProvider fp, PictogramElement oldPe, int xMin, int yMin) {
		super(fp);
		this.oldPe = oldPe;
		this.xMin  = xMin;
		this.yMin  = yMin;
	...
	public void paste(IPasteContext context) {
		...
		OutputPort     oldBo    = null;
	  	...
	  	for(Object o : getAllBusinessObjectsForPictogramElement(oldPe)) {
	  		if(o instanceof OutputPort)         oldBo = (OutputPort) o;
