...
public class CreateConnectionFeatures implements CreateConnectionFeaturesExtension {

	@Override
	public List<Class<? extends ICreateConnectionFeature>> getCreateConnectionFeatures() {
