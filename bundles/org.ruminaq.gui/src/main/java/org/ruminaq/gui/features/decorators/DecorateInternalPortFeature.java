...
public class DecorateInternalPortFeature {
  ...
  public List<IDecorator> getDecorators(IFeatureProvider fp,
      PictogramElement pe) {
  ...
  private Collection<? extends IDecorator> validationDecorators(
      IFeatureProvider fp, PictogramElement pe, Object bo) {
    List<IDecorator> decorators = new LinkedList<>();
  ...
  private Collection<? extends IDecorator> debugDecorators(IFeatureProvider fp,
