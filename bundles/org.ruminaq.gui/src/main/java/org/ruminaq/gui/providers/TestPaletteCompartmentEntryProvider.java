...
public class TestPaletteCompartmentEntryProvider extends FeatureProvider {
	...
	public IPaletteCompartmentEntry[] getPalette() {
	    ...
	    IPaletteCompartmentEntry commonCompartmentEntry = new PaletteCompartmentEntry("Commons", null);
	    ...
	    Map<String, IPaletteCompartmentEntry> extsCompartmentEntries = extensions.getTestPaletteCompartmentEntries(getFeatureProvider().getCreateFeatures());

	    palette.addAll(extsCompartmentEntries.values());
	    compartments.putAll(extsCompartmentEntries);

	    TaskProvider.INSTANCE.getTestPaletteCompartmentEntries(getFeatureProvider().getCreateFeatures(), compartments);
