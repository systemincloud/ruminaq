...
public abstract class AbstractParametersSection extends GFPropertySection implements ITabbedPropertyConstants {
    ...
    private void initLayout(Composite parent) {
        ...
        tblParameters.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1));
    ...
    protected boolean isDefault() { return false; }
                    ...
                    @Override public void keyTraversed(TraverseEvent event) {
                        switch(event.detail) {
                            ...
                            case SWT.TRAVERSE_ESCAPE:
                                String actual = getActualParams().get(tblEdParameters.getItem().getText(0));
    ...
    @Override public void refresh() {
        if(tblParameters.isDisposed()) return;
...
//		Map<String, String> defaultParams = getDefaultParams();
    ...
    protected          Map<String, String> getDefaultParams() { return null; }
