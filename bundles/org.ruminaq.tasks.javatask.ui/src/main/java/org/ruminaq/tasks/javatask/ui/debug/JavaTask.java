...
public class JavaTask extends JavaTasksDebugElement implements IThread, IEventProcessor {
	...
	protected JavaTask(IDebugTarget target, IProject project, NewTaskEvent event) {
		super(target);
		this.id         = event.getId();
