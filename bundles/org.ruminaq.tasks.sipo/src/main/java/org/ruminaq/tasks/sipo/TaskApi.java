...
import org.ruminaq.tasks.sipo.features.AddFeature;
import org.ruminaq.tasks.sipo.features.CreateFeature;
import org.ruminaq.tasks.sipo.features.UpdateFeature;
...
public class TaskApi implements ITaskApi, EclipseExtension {
	...
	public Optional<IAddFeature> getAddFeature(IAddContext cxt, Task t, IFeatureProvider fp) {
	    return ITaskApi.ifInstance(t, Sipo.class, new AddFeature(fp));
	}

	@Override
	public Optional<IUpdateFeature> getUpdateFeature(IUpdateContext cxt, Task t, IFeatureProvider fp) {
	    return ITaskApi.ifInstance(t, Sipo.class, new UpdateFeature(fp));
	}
