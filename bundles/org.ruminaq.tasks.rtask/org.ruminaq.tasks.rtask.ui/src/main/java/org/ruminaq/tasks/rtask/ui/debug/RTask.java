...
public class RTask extends RTasksDebugElement
    implements IThread, IEventProcessor {

  private final Logger logger = ModelerLoggerFactory.getLogger(RTask.class);
  ...
  protected RTask(IDebugTarget target, IProject project, NewTaskEvent event) {
    super(target);
    this.id = event.getId();
