...
import org.ruminaq.tasks.randomgenerator.gui.properties.DecimalProperty;
import org.ruminaq.tasks.randomgenerator.gui.properties.Float32Property;
import org.ruminaq.tasks.randomgenerator.gui.properties.Float64Property;
import org.ruminaq.tasks.randomgenerator.gui.properties.Int32Property;
import org.ruminaq.tasks.randomgenerator.gui.properties.Int64Property;
import org.ruminaq.tasks.randomgenerator.gui.properties.TextProperty;
...
public class PropertySection implements IPropertySection, ValueSaveListener {
  ...
  private void initLayout(Composite parent) {
    ...
    GridData layoutInterval = new GridData(SWT.LEFT, SWT.CENTER, true, false, 1,
        1);
    ...
    GridData specificLayoutData = new GridData(SWT.FILL, SWT.FILL, true, true,
        2, 1);
...
//			types.add(clazz.getSimpleName());
    ...
    this.noSpecific = new PropertySpecificComposite(this, specificRoot, pe,
        ed) {
      {
    ...
    specificComposites.put(Complex32.class.getSimpleName(),
        Complex32Property.createSpecificComposite(this, specificRoot, pe, ed));
    specificComposites.put(Complex64.class.getSimpleName(),
        Complex64Property.createSpecificComposite(this, specificRoot, pe, ed));
    specificComposites.put(Control.class.getSimpleName(),
        ControlProperty.createSpecificComposite(this, specificRoot, pe, ed));
    specificComposites.put(Decimal.class.getSimpleName(),
        DecimalProperty.createSpecificComposite(this, specificRoot, pe, ed));
    specificComposites.put(Float32.class.getSimpleName(),
        Float32Property.createSpecificComposite(this, specificRoot, pe, ed));
    specificComposites.put(Float64.class.getSimpleName(),
        Float64Property.createSpecificComposite(this, specificRoot, pe, ed));
    specificComposites.put(Int32.class.getSimpleName(),
        Int32Property.createSpecificComposite(this, specificRoot, pe, ed));
    specificComposites.put(Int64.class.getSimpleName(),
        Int64Property.createSpecificComposite(this, specificRoot, pe, ed));
    specificComposites.put(Text.class.getSimpleName(),
        TextProperty.createSpecificComposite(this, specificRoot, pe, ed));
    // TODO:
    // specificComposites.putAll(RandomGeneratorExtensionManager.INSTANCE.getComposites(this,
    // specificRoot, pe, ed));
  }
    ...
    txtInterval.addFocusListener(new FocusAdapter() {
      ...
      public void focusLost(FocusEvent event) {
        ...
        if (parse) {
          ...
          MessageDialog.openError(shell, "Can't edit value",
              "Don't understant interval value");
      }
    });
  ...
  public void refresh(PictogramElement pe, TransactionalEditingDomain ed) {
    if (pe != null) {
      Object bo = Graphiti.getLinkService()
          .getBusinessObjectForLinkedPictogramElement(pe);
      if (bo == null || !(bo instanceof RandomGenerator))
        return;
