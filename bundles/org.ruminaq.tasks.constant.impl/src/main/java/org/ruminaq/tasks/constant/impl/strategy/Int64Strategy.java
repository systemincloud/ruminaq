...
public class Int64Strategy extends AbstractConstantStrategy {

    private static final Logger LOGGER = RunnerLoggerFactory.getLogger(Int64Strategy.class);

    public static final String DEFAULT_VALUE = "0";

    public Int64Strategy(ConstantI task, String value) {
        super(task, value);
    }

    @Override
    public void execute() {
        LOGGER.trace("create Int64");
