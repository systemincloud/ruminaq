 ...
 * This configuration can be extended by tasks or extensions.
 *
...
public final class JavaClasspathFile {
     ...
     */
    public void setClasspathEntries(IJavaProject javaProject) throws JavaModelException {
        ...
        entries.addAll(
                extensions.createClasspathEntries(javaProject));

        entries.add(
                JavaCore.newSourceEntry(
                        javaProject.getPath().append(SourceFolders.MAIN_RESOURCES),
                        javaPath));
        entries.add(
                JavaCore.newSourceEntry(
                        javaProject.getPath().append(SourceFolders.TEST_RESOURCES),
                        javaPath,
                        testOutputLocation));
