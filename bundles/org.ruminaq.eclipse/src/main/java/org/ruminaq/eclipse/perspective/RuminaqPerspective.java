...
public class RuminaqPerspective implements IPerspectiveFactory {
	...
	private void defineActions(IPageLayout layout) {
	    ...
	    layout.addNewWizardShortcut("org.ruminaq.eclipse.wizards.project.CreateProjectWizard");           //$NON-NLS-1$
	    layout.addNewWizardShortcut("org.ruminaq.eclipse.wizards.diagram.CreateDiagramWizard");           //$NON-NLS-1$
	    layout.addNewWizardShortcut("org.ruminaq.eclipse.wizards.diagram.CreateTestDiagramWizard");       //$NON-NLS-1$

	    // Add "show views".
	    layout.addShowViewShortcut(IPageLayout.ID_PROJECT_EXPLORER);
	    layout.addShowViewShortcut(IPageLayout.ID_BOOKMARKS);
	    layout.addShowViewShortcut("org.eclipse.graphiti.ui.internal.editor.thumbnailview"); //$NON-NLS-1$
