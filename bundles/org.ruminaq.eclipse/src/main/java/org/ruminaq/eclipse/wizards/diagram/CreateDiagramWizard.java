...
//    diagram.setDiagramTypeId("Ruminaq");
    diagram.setName(name);
//    diagram.setGridUnit(-1);
...
//    diagram.setVisible(true);
    ...
    rectangle.setForeground(gaService.manageColor(diagram, look.getMinorGridLineColor()));
    rectangle.setBackground(gaService.manageColor(diagram, look.getGridBackgroundColor()));
