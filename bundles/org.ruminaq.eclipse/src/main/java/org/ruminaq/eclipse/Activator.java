...
public class Activator extends AbstractUIPlugin {
  ...
  public void start(BundleContext context) throws Exception {
    ...
    IPathVariableManager pathVariableManager = ResourcesPlugin.getWorkspace()
...
//    RuminaqResourceChange.getInstance();
  ...
  public static String getVersionString() {
    return getVersion().toString().replace(Constants.QUALIFIER,
        Constants.SNAPSHOT);
  }

  public static String getBaseVersionString() {
    return getVersion().getMajor() + "." + getVersion().getMinor() + "."
        + getVersion().getMicro();
  }
