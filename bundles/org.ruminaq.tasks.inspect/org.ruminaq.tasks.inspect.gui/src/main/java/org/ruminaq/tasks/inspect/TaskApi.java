...
import org.ruminaq.tasks.inspect.features.CreateFeature;
import org.ruminaq.tasks.inspect.features.DoubleClickFeature;
import org.ruminaq.tasks.inspect.model.inspect.Inspect;
import org.ruminaq.tasks.inspect.model.inspect.InspectPackage;

@Component
public class TaskApi implements ITaskApi, EclipseExtension, LaunchListener {
	...
	public Optional<IAddFeature> getAddFeature(IAddContext cxt, Task t, IFeatureProvider fp) {
	    return ITaskApi.ifInstance(t, Inspect.class, new AddFeature(fp));
	}

	@Override
	public Optional<ICustomFeature> getDoubleClickFeature(IDoubleClickContext cxt, Task t, IFeatureProvider fp) {
	    return ITaskApi.ifInstance(t, Inspect.class, new DoubleClickFeature(fp));
	}
