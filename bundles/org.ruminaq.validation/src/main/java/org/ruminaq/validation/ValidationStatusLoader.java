...
public class ValidationStatusLoader {
    ...
    public Set<EObject> load(TransactionalEditingDomain ed, List<IMarker> markers) {
        ...
        for (IMarker marker : markers) {
            ...
            ValidationStatusAdapter statusAdapter = (ValidationStatusAdapter) EcoreUtil.getRegisteredAdapter(markedObject, ValidationStatusAdapter.class);
    ...
    private EObject getTargetObject(TransactionalEditingDomain ed, IMarker marker) {
        ...
        else return ed.getResourceSet().getEObject(uri, false);
    }
    ...
    private IStatus convertMarker(TransactionalEditingDomain ed, IMarker marker, EObject target) {
        ...
        final IConstraintDescriptor icd = constraintId == null ? null : ConstraintRegistry.getInstance().getDescriptor(constraintId);
        ...
        return new ConstraintStatus(imc, target, message, locus == null ? null : new LinkedHashSet<EObject>((List<? extends EObject>) locus));
    }
}
