...
public abstract class DataI implements Serializable {
  ...
  public boolean isConstantRead() {
    return this.constantRead;
  }

  public void setConstantRead(boolean constantRead) {
    this.constant = constantRead;
  }
  ...
  @SuppressWarnings("unchecked")
  public static <T extends DataI> List<T> get(List<DataI> datas,
      Class<T> type) {
