...
public class DataIUtil {
    ...
    public static Class<? extends DataI> getDataClassForDataType(DataType dataType, Class<?> clazz) {
        ...
        try { dataClazz = (Class<? extends DataI>) Class.forName(clazz.getPackage().getName() + "."  + name + "I");
