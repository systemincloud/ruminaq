...
public class InternalInputPortVariablesEvent extends AbstractPortEvent implements IDebuggerEvent {
	...
	public InternalInputPortVariablesEvent(VariableDebugVisitor visitor, AbstractPortEventListener apel) {
		super(apel);
