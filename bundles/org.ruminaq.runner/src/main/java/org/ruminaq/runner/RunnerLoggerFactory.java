...
public class RunnerLoggerFactory {
  ...
  public static String ERROR_MSG = "Internal error. Please send log file /target/logs/"
      + fileName + " to marek.jagielski@gmail.com to help improve Ruminaq";
  ...
  public static void setLogLevel(String logLevel) {
    RunnerLoggerFactory.logLevel = logLevel;
  }
