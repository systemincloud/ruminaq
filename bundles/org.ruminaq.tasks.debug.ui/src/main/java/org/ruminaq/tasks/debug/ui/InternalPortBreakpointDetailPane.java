...
public class InternalPortBreakpointDetailPane implements IDetailPane3 {
	...
	@Override public void addPropertyListener   (IPropertyListener listener) { listeners.add(listener); }
	@Override public void removePropertyListener(IPropertyListener listener) { listeners.remove(listener); }
	...
	@Override public void init(IWorkbenchPartSite partSite) { site = partSite; }
	...
	public Control createControl(Composite parent) {
		editorParent = SWTFactory.createComposite(parent, parent.getFont(), 1, 1, GridData.FILL_BOTH, 0, 0);
	...
	@Override public boolean isSaveOnCloseNeeded() { return isDirty() && editor.getStatus().isOK(); }
	@Override public boolean setFocus()            { return false; }
	...
	@Override public boolean isDirty() { return editor != null && editor.isDirty();	}
	
	protected AbstractJavaBreakpointEditor getEditor() { return editor; }
