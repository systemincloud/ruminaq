...
public class ModelHandler {
  ...
  public static MainTask getModel(final Diagram diagram,
      final IFeatureProvider iFeatureProvider) {
    if (modelMap.containsKey(diagram))
      return modelMap.get(diagram);
    else {
      MainTask mt = null;

      if (diagram.getLink() != null)
        mt = (MainTask) diagram.getLink().getBusinessObjects().get(0);
      ...
      if (mt == null) {
        ...
        }, iFeatureProvider.getDiagramTypeProvider().getDiagramBehavior()
            .getEditingDomain(), "Model Update");
      }
